...
- If failed: `reason_code`: "FAIL_LITTERING", "FAIL_WASTE_USABLE", "FAIL_OBJECT_TOO_SMALL", or "FAIL_UNCLEAR".
        ...
        # Add instruction
        content_parts.append("Analyze this video showing a waste disposal action and classify according to the protocol.")
        ...
        try:
            ...
            required_fields = ["success", "waste_category", "waste_sub_type", "reason_code"]
